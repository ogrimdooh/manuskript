...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def makeConnections(self):
        ...
        try:
            ...
            self.btnPersoSpInfo.clicked.connect(self.lstCharacters.pasteSortAndKeysCharacterInfo, F.AUC)
            self.btnPersoFirstInfo.clicked.connect(self.lstCharacters.moveFirstCharacterInfo, F.AUC)
            self.btnPersoUpInfo.clicked.connect(self.lstCharacters.moveUpCharacterInfo, F.AUC)
            self.btnPersoDownInfo.clicked.connect(self.lstCharacters.moveDownCharacterInfo, F.AUC)
            self.btnPersoLastInfo.clicked.connect(self.lstCharacters.moveLastCharacterInfo, F.AUC)
        except TypeError:
