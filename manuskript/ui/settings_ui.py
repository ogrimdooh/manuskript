...
class Ui_Settings(object):
    def setupUi(self, Settings):
        ...
        self.pageCharacter = QtWidgets.QWidget()
        self.pageCharacter.setObjectName("pageCharacter")
        self.verticalLayout_character = QtWidgets.QVBoxLayout(self.pageCharacter)
        self.verticalLayout_character.setObjectName("verticalLayout_character")
        self.lblTitleCharacter = QtWidgets.QLabel(self.pageCharacter)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lblTitleCharacter.sizePolicy().hasHeightForWidth())
        self.lblTitleCharacter.setSizePolicy(sizePolicy)
        self.lblTitleCharacter.setAlignment(QtCore.Qt.AlignCenter)
        self.lblTitleCharacter.setObjectName("lblTitleCharacter")
        self.verticalLayout_character.addWidget(self.lblTitleCharacter)
        self.groupBoxCustomCharInfoTitles = QtWidgets.QGroupBox(self.pageCharacter)
        font = QtGui.QFont()
        font.setBold(True)
        self.groupBoxCustomCharInfoTitles.setFont(font)
        self.groupBoxCustomCharInfoTitles.setObjectName("groupBoxCustomCharInfoTitles")
        self.formLayout_customCharInfoTitles = QtWidgets.QFormLayout(self.groupBoxCustomCharInfoTitles)
        self.formLayout_customCharInfoTitles.setObjectName("formLayout_customCharInfoTitles")

        self.lblCharInfoTitles_Motivation = QtWidgets.QLabel(self.groupBoxCustomCharInfoTitles)
        font = QtGui.QFont()
        font.setBold(False)
        self.lblCharInfoTitles_Motivation.setFont(font)
        self.lblCharInfoTitles_Motivation.setObjectName("lblCharInfoTitles_Motivation")
        self.formLayout_customCharInfoTitles.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.lblCharInfoTitles_Motivation)

        self.txtCharInfoTitles_Motivation = QtWidgets.QLineEdit(self.groupBoxCustomCharInfoTitles)
        font = QtGui.QFont()
        font.setBold(False)
        self.txtCharInfoTitles_Motivation.setFont(font)
        self.txtCharInfoTitles_Motivation.setStyleSheet("border-radius: 6px;")
        self.txtCharInfoTitles_Motivation.setAlignment(QtCore.Qt.AlignLeft)
        self.txtCharInfoTitles_Motivation.setObjectName("txtCharInfoTitles_Motivation")
        self.formLayout_customCharInfoTitles.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.txtCharInfoTitles_Motivation)

        self.lblCharInfoTitles_Goal = QtWidgets.QLabel(self.groupBoxCustomCharInfoTitles)
        font = QtGui.QFont()
        font.setBold(False)
        self.lblCharInfoTitles_Goal.setFont(font)
        self.lblCharInfoTitles_Goal.setObjectName("lblCharInfoTitles_Goal")
        self.formLayout_customCharInfoTitles.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.lblCharInfoTitles_Goal)

        self.txtCharInfoTitles_Goal = QtWidgets.QLineEdit(self.groupBoxCustomCharInfoTitles)
        font = QtGui.QFont()
        font.setBold(False)
        self.txtCharInfoTitles_Goal.setFont(font)
        self.txtCharInfoTitles_Goal.setStyleSheet("border-radius: 6px;")
        self.txtCharInfoTitles_Goal.setAlignment(QtCore.Qt.AlignLeft)
        self.txtCharInfoTitles_Goal.setObjectName("txtCharInfoTitles_Goal")
        self.formLayout_customCharInfoTitles.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.txtCharInfoTitles_Goal)

        self.lblCharInfoTitles_Conflict = QtWidgets.QLabel(self.groupBoxCustomCharInfoTitles)
        font = QtGui.QFont()
        font.setBold(False)
        self.lblCharInfoTitles_Conflict.setFont(font)
        self.lblCharInfoTitles_Conflict.setObjectName("lblCharInfoTitles_Conflict")
        self.formLayout_customCharInfoTitles.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.lblCharInfoTitles_Conflict)

        self.txtCharInfoTitles_Conflict = QtWidgets.QLineEdit(self.groupBoxCustomCharInfoTitles)
        font = QtGui.QFont()
        font.setBold(False)
        self.txtCharInfoTitles_Conflict.setFont(font)
        self.txtCharInfoTitles_Conflict.setStyleSheet("border-radius: 6px;")
        self.txtCharInfoTitles_Conflict.setAlignment(QtCore.Qt.AlignLeft)
        self.txtCharInfoTitles_Conflict.setObjectName("txtCharInfoTitles_Conflict")
        self.formLayout_customCharInfoTitles.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.txtCharInfoTitles_Conflict)

        self.lblCharInfoTitles_Epiphany = QtWidgets.QLabel(self.groupBoxCustomCharInfoTitles)
        font = QtGui.QFont()
        font.setBold(False)
        self.lblCharInfoTitles_Epiphany.setFont(font)
        self.lblCharInfoTitles_Epiphany.setObjectName("lblCharInfoTitles_Epiphany")
        self.formLayout_customCharInfoTitles.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.lblCharInfoTitles_Epiphany)

        self.txtCharInfoTitles_Epiphany = QtWidgets.QLineEdit(self.groupBoxCustomCharInfoTitles)
        font = QtGui.QFont()
        font.setBold(False)
        self.txtCharInfoTitles_Epiphany.setFont(font)
        self.txtCharInfoTitles_Epiphany.setStyleSheet("border-radius: 6px;")
        self.txtCharInfoTitles_Epiphany.setAlignment(QtCore.Qt.AlignLeft)
        self.txtCharInfoTitles_Epiphany.setObjectName("txtCharInfoTitles_Epiphany")
        self.formLayout_customCharInfoTitles.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.txtCharInfoTitles_Epiphany)

        self.lblCharInfoTitles_Summary01 = QtWidgets.QLabel(self.groupBoxCustomCharInfoTitles)
        font = QtGui.QFont()
        font.setBold(False)
        self.lblCharInfoTitles_Summary01.setFont(font)
        self.lblCharInfoTitles_Summary01.setObjectName("lblCharInfoTitles_Summary01")
        self.formLayout_customCharInfoTitles.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.lblCharInfoTitles_Summary01)

        self.txtCharInfoTitles_Summary01 = QtWidgets.QLineEdit(self.groupBoxCustomCharInfoTitles)
        font = QtGui.QFont()
        font.setBold(False)
        self.txtCharInfoTitles_Summary01.setFont(font)
        self.txtCharInfoTitles_Summary01.setStyleSheet("border-radius: 6px;")
        self.txtCharInfoTitles_Summary01.setAlignment(QtCore.Qt.AlignLeft)
        self.txtCharInfoTitles_Summary01.setObjectName("txtCharInfoTitles_Summary01")
        self.formLayout_customCharInfoTitles.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.txtCharInfoTitles_Summary01)

        self.lblCharInfoTitles_Summary02 = QtWidgets.QLabel(self.groupBoxCustomCharInfoTitles)
        font = QtGui.QFont()
        font.setBold(False)
        self.lblCharInfoTitles_Summary02.setFont(font)
        self.lblCharInfoTitles_Summary02.setObjectName("lblCharInfoTitles_Summary02")
        self.formLayout_customCharInfoTitles.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.lblCharInfoTitles_Summary02)

        self.txtCharInfoTitles_Summary02 = QtWidgets.QLineEdit(self.groupBoxCustomCharInfoTitles)
        font = QtGui.QFont()
        font.setBold(False)
        self.txtCharInfoTitles_Summary02.setFont(font)
        self.txtCharInfoTitles_Summary02.setStyleSheet("border-radius: 6px;")
        self.txtCharInfoTitles_Summary02.setAlignment(QtCore.Qt.AlignLeft)
        self.txtCharInfoTitles_Summary02.setObjectName("txtCharInfoTitles_Summary02")
        self.formLayout_customCharInfoTitles.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.txtCharInfoTitles_Summary02)

        self.verticalLayout_character.addWidget(self.groupBoxCustomCharInfoTitles)
        spacerItem14 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_character.addItem(spacerItem14)
        self.stack.addWidget(self.pageCharacter)
    ...
    def retranslateUi(self, Settings):
        ...
        item = self.lstMenu.item(7)
        item.setText(_translate("Settings", "Character(s)"))
...
" to words"))
        ...
        self.lblTitleCharacter.setText(_translate("Settings", "Character(s)"))
        self.groupBoxCustomCharInfoTitles.setTitle(_translate("Settings", "Custom character info titles"))
        self.lblCharInfoTitles_Motivation.setText(_translate("Settings", "Motivation"))
        self.lblCharInfoTitles_Goal.setText(_translate("Settings", "Goal"))
        self.lblCharInfoTitles_Conflict.setText(_translate("Settings", "Conflict"))
        self.lblCharInfoTitles_Epiphany.setText(_translate("Settings", "Epiphany"))
        self.lblCharInfoTitles_Summary01.setText(_translate("Settings", "One sentence summary"))
        self.lblCharInfoTitles_Summary02.setText(_translate("Settings", "One paragraph summary"))
