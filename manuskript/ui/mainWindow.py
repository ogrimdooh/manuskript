...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnPersoCpInfo = QtWidgets.QPushButton(self.tab_12)
        self.btnPersoCpInfo.setText("")
        icon = QtGui.QIcon.fromTheme("edit-copy")
        self.btnPersoCpInfo.setIcon(icon)
        self.btnPersoCpInfo.setObjectName("btnPersoCpInfo")
        self.horizontalLayout_9.addWidget(self.btnPersoCpInfo)
        self.btnPersoCtInfo = QtWidgets.QPushButton(self.tab_12)
        self.btnPersoCtInfo.setText("")
        icon = QtGui.QIcon.fromTheme("edit-cut")
        self.btnPersoCtInfo.setIcon(icon)
        self.btnPersoCtInfo.setObjectName("btnPersoCtInfo")
        self.horizontalLayout_9.addWidget(self.btnPersoCtInfo)
        self.btnPersoPtInfo = QtWidgets.QPushButton(self.tab_12)
        self.btnPersoPtInfo.setText("")
        ...
        MainWindow.setTabOrder(self.btnPersoRmInfo, self.btnPersoCpInfo)
        MainWindow.setTabOrder(self.btnPersoCpInfo, self.btnPersoPtInfo)
        MainWindow.setTabOrder(self.btnPersoPtInfo, self.lineEdit)
